        ...
        <table class="table table-striped" id="eventList">
            <thead>
                <tr>
                    ...
                    <?php
                    echo '<th>';
                    echo HTMLHelper::_('searchtools.sort', 'Date', 'a.event_date', $listDirn, $listOrder);
                    echo ' </th>' . PHP_EOL;

                    echo '<th class="location">';
                    echo HTMLHelper::_('searchtools.sort', 'Type', 'event_type.description', $listDirn, $listOrder);
                    echo ' </th>' . PHP_EOL;
                    ...
                    echo '<th class="location">';
                    echo HTMLHelper::_('searchtools.sort', 'Organiser', 'c.name', $listDirn, $listOrder);
                    echo ' </th>' . PHP_EOL;

                    echo '<th class="location">';
                    echo HTMLHelper::_('searchtools.sort', 'Location', 'a.location', $listDirn, $listOrder);
                    echo ' </th>' . PHP_EOL;

                    echo '<th>';
//                    $image = '<img src="' . uri::Base() . 'media/com_ra_tools/link.png' . '" alt="URL" width="20" height="20" />';
                    echo HTMLHelper::_('searchtools.sort', 'Link', 'a.url', $listDirn, $listOrder);
                    echo '</th>' . PHP_EOL;
...
//                    $image = '<span class="icon-paperclip"></span>';
                    ...
                    echo HTMLHelper::_('searchtools.sort', 'Bookable', 'a.bookable', $listDirn, $listOrder);
                    echo ' </th>' . PHP_EOL;
