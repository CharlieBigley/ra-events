...
//
        ...
        $sql .= 'b.special_request, b.custom1, b.custom2 ';
        $sql .= 'FROM #__ra_profiles AS p ';
        ...
        foreach ($rows as $row) {
            ...
            $body .= HTMLHelper::_('date', $row->created, 'd M y H:i') . ',' . $row->preferred_name . ', ' . $row->title;
            $body .= ',' . $row->special_request;
            if ($item->booking1 !== '') {
                $body .= ',' . $row->custom1;
            }
            if ($item->booking2 !== '') {
