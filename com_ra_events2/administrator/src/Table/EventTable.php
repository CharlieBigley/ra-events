 ...
 * 03/12/24 CB change group_code to upper case
 * 18/12/24 CB only check holiday end date once record has been saved
...
//        $date = Factory::getDate();
        ...
        if (($array['api_site_id'] OR 0) OR $array['api_site_id'] == '') {
            if (($array['event_type_id'] == 1) and $array['details'] == '') {
                // If committee meeting, set up defaults
                $toolsHelper = new ToolsHelper;
                $sql = 'DELETE FROM #__ra_events WHERE id=23';
