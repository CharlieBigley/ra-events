...
<form action="<?php echo Route::_('index.php?option=com_ra_events&view=reports'); ?>" method="post" name="reportsForm" id="reportsForm">
    <div id="j-main-container" class="span10">
        ...
        $objTable->add_item("Imported Events");
        $objTable->add_item($toolsHelper->buildButton("administrator/index.php?option=com_ra_events&task=reports.importedEvents", "Go", False, 'red'));
        $objTable->generate_line();
