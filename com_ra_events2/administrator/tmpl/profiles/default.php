                ...
                <table class="table table-striped" id="profileList">
                    <thead>
                        <tr>
                            ...
                            <th class='left'>
                                <?php echo HTMLHelper::_('searchtools.sort', 'Preferred name', 'a.preferred_name', $listDirn, $listOrder); ?>
                            </th>
                            <th class='left'>
                                <?php echo HTMLHelper::_('searchtools.sort', 'Real name', 'a.real_name', $listDirn, $listOrder); ?>
                            </th>
                            <th class='left'>
